...
export default class type extends Component {
  ...
  handleSubmit(event) {
    ...
    const search = this.props.navigation.getParam('type', 'nothing sent');
    console.log(search);
    console.log(this.state.searching);
    axios
      .post('http://192.168.8.232:3000/item/type', {search})
      .then((res) => {
        // console.log(res);
          ...
          <View style={styles.mainbodyView}>
            <View>
              <Text
                ...
                Item: {this.props.navigation.getParam('type', 'nothing sent')}
              </Text>
              <Button
                type="submit"
                title={'Start seaching'}
                color="#102538"
